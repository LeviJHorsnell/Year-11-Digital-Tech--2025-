...
if answer1 == "Yes":
    ...
    answer10=easygui.buttonbox("Which of these moves is exclusive to " + list_q[9], choices=["Signal beam", list_a[9], "Defense curl", "Magnet rise"])
    if answer10 == list_a[9]:
        if name == "kp":
            score += 2
        else:
            score += 1
    ...
    if score <=3:
        ...
        easygui.msgbox(name + ", you did very well on this test! Your score was " + str(score))
    elif score >9:
        easygui.msgbox("Unbelievable! Your score was " + str(score))
